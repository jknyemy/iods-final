...
The purpose of this analysis is to compare the variables of the dataset to some variables of interest. The first of these variables is the HDI value and the fertility of women, summaries of which are here:
...
```{r correlplot}
corrplot(cor(hdi.aid[3:17]), type="upper")
```
